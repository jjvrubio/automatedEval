...
```bash
export ACTA_PASSWORD='CHANGE_ME'
export ACTA_EMAIL_SECRETARIO='secretary@example.org'  # opcional
python "01_Educativa/0101_UNIR/AutomatedEval/Completar Acta y Rúbrica/importarActa.py"
```
