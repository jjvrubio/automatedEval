...
sys.path.insert(
    0,
    "/Users/juanjo/Documents/Personal/JJVR/automatizaciones/automatedEval/Grading/UNIR Grading",
)
...
def test_extraccion_elementos_unicos():
    ...
    try:
        from Evaluador_TFM_Integrado_ultraestricto import (
            extraer_elementos_unicos_del_documento,
        )
        ...
        print("🔍 Elementos únicos extraídos:")
        print(elementos)
...
def test_max_tokens():
    ...
    with open(
        "/Users/juanjo/Documents/Personal/JJVR/automatizaciones/automatedEval/Grading/UNIR Grading/Evaluador_TFM_Integrado_ultraestricto.py",
        "r",
    ) as f:
        contenido = f.read()
...
def main():
    ...
    if tests_ok == len(tests):
        print(
            "🎉 ¡TODOS LOS TESTS PASARON! El evaluador debe generar análisis únicos ahora."
        )
        return True
    else:
        print(
            "⚠️ Algunos tests fallaron. El evaluador puede seguir generando análisis idénticos."
        )
        return False
