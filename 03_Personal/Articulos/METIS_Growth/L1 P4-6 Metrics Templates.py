...
kpi_data = [
    [
        "Response Time",
        "Average time taken to respond to stakeholder inquiries.",
        "Track timestamps of incoming and outgoing communications.",
        "Reduce average response time by 20% within six months.",
    ],
    [
        "Engagement Level",
        "Percentage of stakeholders actively participating in discussions.",
        "Analyze participation rates in meetings and surveys.",
        "Increase engagement by 15% quarterly.",
    ],
]
...
kpi_tracking_data = [
    [
        ...
        "2 hours",
        "Decreased by 15%",
        "Implemented automated alerts for urgent inquiries.",
    ],
    [
        "Engagement Level",
        "85%",
        "Increased by 10%",
        "Introduced interactive sessions in meetings.",
    ],
]
...
feedback_data = [
    [
        ...
        "Stakeholders appreciate regular updates but suggest bi-weekly summaries.",
        "Some stakeholders mentioned they receive too many daily updates.",
    ],
    [
        "Clarity of Communication",
        "Some stakeholders find technical jargon confusing.",
        "One stakeholder noted difficulty understanding a recent email about project milestones.",
    ],
    [
        "Responsiveness",
        "High satisfaction with response times, with minor suggestions for improvement.",
        "A few stakeholders suggested setting up an after-hours contact method.",
    ],
]
...
iteration_data = [
    [
        "Simplify Language in Emails",
        "Revise email templates to eliminate technical jargon and simplify language.",
        "Immediate",
        "Communication Manager",
    ],
    [
        "Introduce Bi-Weekly Summary Reports",
        "Develop and distribute bi-weekly summary reports to stakeholders.",
        "Next quarter",
        "Project Coordinator",
    ],
]
