...
def create_influencer_engagement_plan():
    ...
    for influencer in influencers:
        doc.add_paragraph(
            f"Name: {influencer['Name']}, Followers: {influencer['Followers']}, Topics: {influencer['Topics']}"
        )

    # Proposed Collaboration Strategies
    doc.add_heading("Proposed Collaboration Strategies", level=2)
    strategies = ["Co-create wellness-themed posts.", "Offer exclusive discount codes."]
    for s in strategies:
        doc.add_paragraph(s)
