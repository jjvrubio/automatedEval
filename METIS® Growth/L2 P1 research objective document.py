...
def create_research_objective_document():
    ...
    doc.add_paragraph('To understand consumer preferences and cultural nuances in the target market.')
    ...
    doc.add_paragraph('Focus on urban professionals aged 25-40 with medium to high disposable income.')
