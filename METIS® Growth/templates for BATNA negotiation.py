...
def create_sale_pattern_framework():
    ...
    doc.add_paragraph("This section defines the structured and repeatable sales configuration "
    ...
    doc.add_paragraph("Predefined contract structures to ensure consistency across sales engagements.")

    doc.add_heading('3. Deal Success Playbook', level=1)
    doc.add_paragraph("This section documents lessons learned from prior deals, including common objections and "
                      "successful negotiation strategies.")

    doc.add_heading('4. Continuous Optimization Mechanism', level=1)
    doc.add_paragraph("A structured feedback loop ensuring ongoing refinement of the Sale Pattern Framework.")
