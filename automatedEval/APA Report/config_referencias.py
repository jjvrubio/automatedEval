    ...
    "apa": {
        ...
        "patrones": {
            ...
            "titulo_articulo": {
                ...
                "regex": r"[A-ZÁÉÍÓÚÜ][^.]+\.",
                "ejemplos": ["Efectos del cambio climático.", "Machine learning applications."]
            },
            "titulo_revista": {
    ...
    "ieee": {
        ...
        "patrones": {
            ...
            "titulo_articulo": {
                "formato": "\"Título del artículo,\"",
                "regex": r'"[^"]+",',
                "ejemplos": ["\"Machine learning applications,\"", "\"Efectos del clima,\""]
            },
            "titulo_revista": {
                "formato": "Título de la Revista",
                "regex": r"[A-ZÁÉÍÓÚÜ][^,]+",
    ...
    "mla": {
        ...
        "patrones": {
            ...
            "titulo_articulo": {
                "formato": "\"Título del Artículo.\"",
                "regex": r'"[^"]+\."',
                "ejemplos": ["\"Machine Learning Applications.\"", "\"Efectos del Cambio Climático.\""]
            },
            "titulo_revista": {
                "formato": "Título de la Revista,",
                "regex": r"[A-ZÁÉÍÓÚÜ][^,]+,",
...
IDIOMAS_CONFIGURACION = {
    "español": {
        ...
        "editoriales_comunes": [
            "editorial", "ediciones", "ed.", "editores",
            "universidad", "instituto", "centro"
        ]
    },
    ...
    "english": {
        ...
        "editoriales_comunes": [
            "press", "publisher", "publications", "university",
            "institute", "center", "foundation", "society"
        ]
    }
}
...
TIPOS_PUBLICACION = {
    "articulo_revista": {
        "componentes_requeridos": ["autor", "anio", "titulo_articulo", "titulo_revista", "volumen", "paginas"],
    ...
    "capitulo_libro": {
        "componentes_requeridos": ["autor", "anio", "titulo_capitulo", "editor", "titulo_libro", "editorial", "paginas"],
        "componentes_opcionales": ["isbn"],
        "peso_validacion": 0.8
    },
    
    "tesis": {
        "componentes_requeridos": ["autor", "anio", "titulo", "tipo_tesis", "institucion"],
        "componentes_opcionales": ["url", "repositorio"],
        "peso_validacion": 0.7
    },
    
    "web": {
        "componentes_requeridos": ["autor_o_organizacion", "anio_o_fecha", "titulo", "url"],
